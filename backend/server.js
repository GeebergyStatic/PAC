...
app.post("/api/send-email", async (req, res) => {
    try {
        ...
        else if (context === "kirkDonation") {
            emailHtml = fillTemplate(process.env.KIRK_DONATION_EMAIL_TEMPLATE, variables);
            emailSubject = fillTemplate(process.env.KIRK_DONATION_EMAIL_SUBJECT, variables);
        } else {
